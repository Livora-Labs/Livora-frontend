...
export default function HogarTransfersPage() {
  ...
  return (
    <Shell role="hogar">
      ...
      <PageHead
        ...
        description="Consulta las transferencias on-chain de tu hogar, incluyendo recompensas por reciclaje y canjes en comercios."
        action={
      ...
      <div className="grid kpis" style={{ gridTemplateColumns: "repeat(3, 1fr)", marginBottom: 24 }}>
        ...
        <Kpi label="RECOMPENSAS RECIBIDAS" value={`${incomingCount}`} trend="Ingresos por reciclaje" accent="var(--blue)" />
        <Kpi label="CANJES REALIZADOS" value={`${outgoingCount}`} trend="Pagos en comercios" accent="var(--amber)" />
      </div>
