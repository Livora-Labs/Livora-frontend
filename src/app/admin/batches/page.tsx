  ...
  return (
    <>
      <PageHead
        ...
        description="Sigue cada lote desde la recolección hasta su registro verificable en blockchain."
        action={<button className="btn primary">+ Registrar lote</button>}
      />
      <div className="toolbar">
        <div className="search">
          <input placeholder="Buscar por ID, recolector o centro..." />
        </div>
